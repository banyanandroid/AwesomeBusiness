...
import banyan.com.awesomebusiness.activity.Tab_User_FranchiseProfile_Bookmarked;
...
public class List_User_FranchiseProfiles_Bookmark_View_Adapter extends BaseAdapter {
    ...
    public List_User_FranchiseProfiles_Bookmark_View_Adapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ///////////
        String str_username = result.get(Tab_User_FranchiseProfile_Bookmarked.TAG_USER_NAME);
        String str_user_connect_status = result.get(Tab_User_FranchiseProfile_Bookmarked.TAG_USER_CONNECT);
        String str_user_type = result.get(Tab_User_FranchiseProfile_Bookmarked.TAG_USER_TYPE);


        /////////////
        txt_username.setText(str_username);

        System.out.println("str_user_connect_status :::::: " +str_user_connect_status);

        //If else condition to set the user status accordingly
