...
public class List_User_BusinessProfiles_Bookmark_View_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ///////////
        String str_username = result.get(Tab_User_BusinessProfile_Bookmarked.TAG_USER_NAME);
        String str_user_connect_status = result.get(Tab_User_BusinessProfile_Bookmarked.TAG_USER_CONNECT);
        String str_user_type = result.get(Tab_User_BusinessProfile_Bookmarked.TAG_USER_TYPE);
