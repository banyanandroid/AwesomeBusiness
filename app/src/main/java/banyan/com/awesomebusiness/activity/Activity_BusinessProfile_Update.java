...
import banyan.com.awesomebusiness.adapter.Horizondal_Image_Adapter;
...
public class Activity_BusinessProfile_Update extends AppCompatActivity {
    ...
    private Horizondal_Image_Adapter mAdapter;

    private Horizondal_Image_Adapter Horizondal_Image_Adapter;
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; arr_main.length() > i; i++) {
                            ...
                            String business_ebitda_range = obj_data.optString(TAG_BUSINESS_EBITDA_RANGE); // chb_display as range
